...
## 254. NCP PUT Content-Type 재시도·칸 이름 보강 되돌리기 (선택)

업로드 PUT 서명·엑셀/수신 템플릿 칸 이름 보강 후 문제가 생기면:

`at
restore-put-fix-labels.bat
`
...
src.pre-inbox-xlsx-font/ �� public.pre-inbox-xlsx-font/ ���������� �ǵ����ϴ�.
...
src.pre-trip-presurvey-template/ �� public.pre-trip-presurvey-template/ ���������� �ǵ����ϴ�.
...
## Landing UTF-8 fix restore (2026-08-11)
...
## Join App Links restore (2026-08-12)
