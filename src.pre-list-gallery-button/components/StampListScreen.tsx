...
// eslint-disable-next-line @typescript-eslint/no-require-imports
const galleryIcon = require('../../assets/gallery-icon.png');
        ...
        <View style={styles.bottomBar}>
          ...
          >
            {albumBusy ? (
              ...
              <>
                <Image source={galleryIcon} style={styles.bottomGalleryIcon} resizeMode="cover" />
                <Text style={styles.bottomAttachText}>갤러리</Text>
              </>
            )}
          </Pressable>
          <Pressable
