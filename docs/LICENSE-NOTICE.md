...
- 앱 아이콘 (`assets/icon.png`, `assets/app-icon-source.png`, `assets/android-icon-foreground.png` 등)
- 온보딩·UI PNG (`img/`, `assets/`) — 일부는 파일명에 "ChatGPT Image ..."가 남아있어 AI 이미지 생성 서비스로 만든 에셋임을 확인
...
### 6.1 AI 생성 이미지(ChatGPT/DALL·E) 이용약관 확인 — 2026-09-10

| 항목 | 내용 |
|------|------|
| 대상 에셋 | 앱 아이콘(`app-icon-source.png` 등 마이크+사진 모티프), `assets/`·`img/`의 "ChatGPT Image ..." 온보딩/설정 아이콘 PNG |
| 확인 근거 | OpenAI 이용정책·서비스 약관(2026년 현재 공개 요약): 사용자가 ChatGPT/DALL·E로 생성한 이미지의 **소유권은 사용자**에게 있으며, OpenAI 사용정책(저작권 침해·실존 인물 기만적 묘사·유해 콘텐츠 금지 등)을 지키는 한 **상업적 목적 포함 자유롭게 사용** 가능 |
| 제약 검토 | 대상 에셋을 육안 확인한 결과 실존 인물, 제3자 로고·캐릭터를 모사하지 않은 범용 아이콘(마이크+사진, 톱니바퀴 등)으로 확인됨 — OpenAI 사용정책 위반 소지 없음 |
| 한계 | 본 확인은 공개된 정책 요약에 근거한 내부 점검이며, 원문 약관 전체·최신 개정 여부는 상업 배포(Play Production) 직전 재확인 권장 |
| 결론 | 위 에셋은 **상업적 사용 가능**으로 판단, 별도 라이선스 표기 불필요 (OpenAI 소유권 이전 조항에 따름) |
...
| 2026-08-22 | 저장·수정 미리보기 이미지 저장. 신규 의존성·폰트·권한 없음. GPL 없음 |
| 2026-08-23 | 저장·수정 탭 화면 표시 글. 신규 의존성·폰트·권한 없음. GPL 없음 |
| 2026-08-23 | 이음 제목 번호. 신규 의존성·폰트·권한 없음. GPL 없음 |
| 2026-08-23 | 연결 비교 엑셀 사진 가로. 신규 의존성·폰트·권한 없음. GPL 없음 |
| 2026-08-23 | 날짜별·APK별 문서 정리. 소스·의존성 변경 없음. 권장 APK `181951` |
| 2026-09-14 | HWPX 표·사진 조금 작게(한 쪽). 글꼴 파일 없음. 신규 의존성·GPL 없음 |
| 2026-09-14 | HWPX 한글 1칸 서식 재적용·랜딩 APK 직접 주소. 글꼴 파일 없음. 신규 의존성·GPL 없음 |
| 2026-09-14 | HWPX 한 칸 사진·캡션 덩어리. 글꼴 파일 없음. 신규 의존성·GPL 없음 |
| 2026-09-14 | HWPX 사진·캡션 2행 표·쪽 칸에 사진 맞춤. 글꼴 파일 없음. 신규 의존성·GPL 없음 |
| 2026-09-14 | HWPX 첫 사진 누락 보정(BinData/hpf·표 안 맞춤·제목 다음 쪽). 글꼴 파일 없음. 신규 의존성·GPL 없음 |
| 2026-09-14 | HWPX 서식에 한글이 넣은 사진 표를 적용. 글꼴 파일 없음. 신규 의존성·GPL 없음 |
| 2026-09-11 | HWPX 보내기를 `110523` 동작(서식 채우기·페이지당 장수)으로 되돌림. 글꼴 파일 없음. 신규 의존성·GPL 없음 |
| 2026-08-23 | 저장 목록 엑셀 사진 가로. 신규 의존성·폰트·권한 없음. GPL 없음 |
| 2026-08-23 | 날짜별·APK별 문서 정리. 소스·의존성 변경 없음 |
| 2026-09-10 | §6.1 신설 — AI 생성 이미지(ChatGPT/DALL·E) 이용약관 공식 확인 기록. OpenAI 소유권 이전·상업적 사용 허용 조항 근거로 앱 아이콘·온보딩 아이콘 상업적 사용 가능 판단. 신규 의존성·소스 변경 없음 |
