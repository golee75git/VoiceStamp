...
> **2026-09-15:** 권장 = `releases/VoiceStamp_20260915_112033.apk`. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md) §2.
| APK (권장) | 커밋 | 한 줄 |
|------------|------|--------|
| `releases/VoiceStamp_20260915_112033.apk` | (본 커밋) | **설치·GitHub 권장** — 큰 미리보기 글 칸이 사진 위에 보임 |
