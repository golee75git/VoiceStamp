...
> **2026-08-18:** 권장 = `releases/VoiceStamp_20260818_091805.apk`. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md) §2.
| APK (권장) | 커밋 | 한 줄 |
|------------|------|--------|
| `releases/VoiceStamp_20260818_091805.apk` | (푸시 후) | **설치·GitHub 권장** — 참여 목록 종료됨 표시 |
