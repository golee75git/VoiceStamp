...
| 문서 버전 | 3.13 |
| 작성일 | 2026-08-16 |
| 기준 커밋 | `0601b0a` — 권장 APK `164812` · 참여 사업 갤러리·목록 보내기 |
...
> **2026-08-16:** 권장 = `releases/VoiceStamp_20260816_164812.apk`. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md) §2.
| APK (권장) | 커밋 | 한 줄 |
|------------|------|--------|
