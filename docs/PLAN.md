...
> **2026-09-14:** 권장 = `releases/VoiceStamp_20260914_151454.apk`. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md) §2.
| APK (권장) | 커밋 | 한 줄 |
|------------|------|--------|
| `releases/VoiceStamp_20260914_151454.apk` | (본 커밋) | **설치·GitHub 권장** — HWPX 표·사진 조금 작게 |
