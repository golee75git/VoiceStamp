...
| 문서 버전 | 3.13 |
| 작성일 | 2026-08-16 |
| 기준 커밋 | `5f9e722` — 권장 APK `190729` · 앱 내 미리보기 QR 열기 |
...
> **2026-08-16:** 권장 = `releases/VoiceStamp_20260816_190729.apk`. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md) §2.
| APK (권장) | 커밋 | 한 줄 |
|------------|------|--------|
