...
> **권장 APK (07-11):** `releases/VoiceStamp_20260711_101055.apk`.

## 2Z. Phase 3 추가 완료 (2026-07-13)

| # | 기능 | 커밋 | RESTORE |
|---|------|------|---------|
| 261 | `/report` **행 삭제** | `61a32ca` | `restore-report-row-delete.bat` §150 |
| 262 | 프로젝트 ZIP **PDF 미포함** (속도) | `a58157f` | `restore-project-zip-no-pdf.bat` §151 |
...
| **F-QR-01** | ~~미구현~~ → ✅ caption MVP (`114713`) — 워터마크/PDF QR는 이후 | MIT `qrcode` · `restore-qr-caption.bat` |
...
| ID | 내용 | 비고 |
|----|------|------|
| **AI-ML-01** | **ML Kit Image Labeling** — 촬영 후 메모 키워드 초안 | ✅ 재도입 `06ae8e2`/`114802` — [DESIGN-ML-KIT-SCENE-LABEL.md](./DESIGN-ML-KIT-SCENE-LABEL.md) · 과거 되돌림 이력 |
...
| **AI-ML-03** | **ML Kit Korean OCR** — 사진 글자 → **제목·메모 초안**(규칙, 생성형 없음) | ✅ MVP `8b74ccf`/`104328` · 긴 메모 스크롤 `1413de9` — [DESIGN-ML-KIT-OCR-TITLE.md](./DESIGN-ML-KIT-OCR-TITLE.md) |
...
| 최신 APK (문서 기준) | `releases/VoiceStamp_20260810_113846.apk` |
| GitHub APK raw | https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260810_113846.apk |
| 최신 소스 | `dda285a` — 엑셀 글자·800칩 + 08-08~10 취합 누적 |
...
| 2026-08-08 | 4·3 | 조인·배지·**수신함 병합** · NCP 직통·초대 템플릿·엑셀 · APK `081515`~`231815` |
| 2026-08-08 | 문서 | RELEASE-CHANNELS · PRD/PLAN/PROJECT/README/CHANGELOG (`6811dc9`) |
...
| 2026-09-17 | 4·3 | 내보내기 기본 파일명에 **장소** · 여러 장 **이미지 저장은 장별 이름** · APK `175121` · `restore-export-file-place.bat` |
...
| 2026-09-14 | 4·3 | 저장 화면 **시스템 뒤로가기**가 흰 화면에 머물지 않게 · APK `190436` · `restore-save-sheet-back.bat` |
| 2026-09-14 | 4·3 | 저장 화면 **칸 이름 탭**이 메모로 내려가지 않게 · APK `183910` · `restore-save-label-stay.bat` |
| 2026-09-14 | 4·3 | **HWPX 표·사진 조금 작게**(한 쪽) · APK `151454` · `restore-hwpx-table-slack.bat` |
| 2026-09-14 | 4·3 | **HWPX 한글 1칸 서식 재적용** · 랜딩 APK 주소·캐시 · APK `144257` · `restore-hwpx-reapply-1cell.bat` |
| 2026-09-14 | 4·3 | **HWPX 한 칸** 사진·캡션 덩어리 · APK `142225` · `restore-hwpx-caption-blob.bat` |
...
| 2026-08-18 | 4·3 | 앱 내 미리보기 **검정 화면 수정** · APK `105424` · `restore-inapp-preview-surface.bat` |
...
| 2026-08-16 | 4·3 | 미리보기 QR **열기 중에도 셔터 촬영** · APK `202344` · `restore-preview-qr-capture-fix.bat` |
| 2026-08-16 | 4·3 | 앱 내 미리보기 **http(s) QR 열기** · APK `190729` · `restore-preview-qr-open.bat` |
...
> **2026-09-17:** 권장 = `releases/VoiceStamp_20260917_175121.apk`. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md) §2.
| APK (권장) | 커밋 | 한 줄 |
|------------|------|--------|
| `releases/VoiceStamp_20260917_175121.apk` | (본 커밋) | **설치·GitHub 권장** — 내보내기 파일명 장소·장별 JPEG 이름 |
| `releases/VoiceStamp_20260917_102508.apk` | (이전) | **이전** — 사진 위 글 저장 위치를 글자 상단에 맞춤 |
...
| `releases/VoiceStamp_20260728_111800.apk` | `2124da6` | **이전** — 카메라 홈 mainint |
