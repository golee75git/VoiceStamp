...
문서 작성일: **2026-07-31**
문서 동기화: **2026-08-16** — 엑셀 5장 이상 가로 막대 · [CHANGELOG.md](./CHANGELOG.md) (권장 APK `141835`)
최신 기능 커밋 기준: `d521763` / APK `141835`
...
| APK 파일 | 커밋 | 주요 변경 | 배포 |
|----------|------|-----------|------|
| `releases/VoiceStamp_20260816_141835.apk` | `d521763` | **권장** — 엑셀 5장 이상 가로 막대 · `restore-xlsx-row-fill.bat` | **GitHub `releases/`** |
