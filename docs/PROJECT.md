...
| 374 | 앱 내 미리보기 **검정 화면 수정** | (빌드 후) | `restore-inapp-preview-surface.bat` |
...
| APK 파일 | 커밋 | 주요 변경 | 배포 |
|----------|------|-----------|------|
| `releases/VoiceStamp_20260818_105424.apk` | (푸시 후) | **권장** — 앱 내 미리보기 검정 화면 수정 · `restore-inapp-preview-surface.bat` | **GitHub `releases/`** |
