...
문서 작성일: **2026-07-31**
문서 동기화: **2026-08-03** — 항목 말하기(표시명) · 장소 칩 · 앨범 EXIF · 권장 APK `161016`
...
| 369 | **표시명** 「항목 말하기」/「저장 직후 음성으로 항목 채우기」 | (본 커밋) | `restore-item-speak-label.bat` §219 |
| 370 | GitHub APK `releases/20260803_161016` · 랜딩·`/info` | (본 커밋) | — |
...
| 파일 | 커밋 | 비고 |
|------|------|------|
| **`releases/VoiceStamp_20260803_161016.apk`** | (본 커밋) | **설치·GitHub 권장** — 「항목 말하기」표시명 + 08-03 누적 |
...
| APK 파일 | 커밋 | 주요 변경 | 배포 |
|----------|------|-----------|------|
| `releases/VoiceStamp_20260803_161016.apk` | (본 커밋) | **권장** — 「항목 말하기」표시명 (+08-03 누적) | **GitHub `releases/`** |
