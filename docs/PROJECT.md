...
문서 작성일: **2026-07-31**
최신 기능 커밋 기준: (본 커밋) — **성능 번들 C** · APK `VoiceStamp_20260801_193317` · 이전 `9d8ccfa`
...
| 349 | **성능 번들 C** — 내보내기 동적 import | (본 커밋) | `restore-perf-bundle-c.bat` §206 |
| 350 | GitHub APK `releases/20260801_193317` · 랜딩·`/info` | (본 커밋) | `restore-apk-download-20260801_193317.bat` |
...
| 파일 | 커밋 | 비고 |
|------|------|------|
| **`releases/VoiceStamp_20260801_193317.apk`** | (본 커밋) | **설치·GitHub 권장** — **성능 번들 C** + B/A 누적 |
...
| APK 파일 | 커밋 | 주요 변경 | 배포 |
|----------|------|-----------|------|
| `releases/VoiceStamp_20260801_193317.apk` | (본 커밋) | **권장** — **성능 번들 C** · `restore-perf-bundle-c.bat` | **GitHub `releases/`** |
...
> **권장 APK:** `releases/VoiceStamp_20260801_193317.apk` (본 커밋).
