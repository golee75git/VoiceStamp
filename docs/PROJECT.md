...
| 373 | 앱 내 미리보기 **3:4 비율 맞춤**(자르기 없음) | `8037079` | `restore-inapp-preview-fit.bat` |
| 374 | 앱 내 미리보기 **검정 화면 수정** | `2491781` | `restore-inapp-preview-surface.bat` |
| 375 | 셔터 시 **미리보기 유지**·3:4 위쪽 고정 | (빌드 후) | `restore-inapp-shutter-keep.bat` |
...
| APK 파일 | 커밋 | 주요 변경 | 배포 |
|----------|------|-----------|------|
| `releases/VoiceStamp_20260823_181951.apk` | `bba7014` | **권장** — 연결 비교 엑셀 사진 가로 · `restore-follow-xlsx-photo-px.bat` | **GitHub `releases/`** |
| `releases/VoiceStamp_20260823_173038.apk` | `a5f627a` | **이전** — 저장 목록 엑셀 사진 가로 · `restore-list-xlsx-photo-px.bat` | **GitHub `releases/`** |
...
| APK 파일 | 커밋 | 주요 변경 | 배포 |
|----------|------|-----------|------|
| `releases/VoiceStamp_20260814_171058.apk` | `e9f0bae` | **이전** — 수신함 고름 표시·엑셀 미선택 안내 · `restore-inbox-pick-mark.bat` | **GitHub `releases/`** |
...
| 항목 | 내용 |
|------|------|
| 분류 | 사진 위 글 저장 위치를 글자 상단에 맞춤 |
| APK | `releases/VoiceStamp_20260917_102508.apk` |
| 롤백 | `restore-note-pad-rise.bat` |
| 문서 | [CHANGELOG.md](./CHANGELOG.md) · [SECURITY-note-pad-rise-20260917.md](./SECURITY-note-pad-rise-20260917.md) |
...
| 항목 | 내용 |
|------|------|
| 분류 | 큰 미리보기 「글 칸 추가」를 스크롤 밖에 두어 눌림만 남던 문제 수정 |
| APK | `releases/VoiceStamp_20260915_103528.apk` |
| 롤백 | `restore-note-pad-press.bat` |
| 문서 | [CHANGELOG.md](./CHANGELOG.md) · [SECURITY-note-pad-press-20260915.md](./SECURITY-note-pad-press-20260915.md) |
...
| 항목 | 내용 |
|------|------|
| 분류 | 칸 이름 탭 시 메모로 스크롤되지 않음(메모·글자 읽기는 유지) |
| APK | `releases/VoiceStamp_20260914_183910.apk` |
| 롤백 | `restore-save-label-stay.bat` |
| 문서 | [CHANGELOG.md](./CHANGELOG.md) · [SECURITY-save-label-stay-20260914.md](./SECURITY-save-label-stay-20260914.md) |
...
| 항목 | 내용 |
|------|------|
| 분류 | 한글 `report.hwpx` 1칸 재적용 · 랜딩 APK 직접 주소·HTML 캐시 |
| APK | `releases/VoiceStamp_20260914_144257.apk` |
| 롤백 | `restore-hwpx-reapply-1cell.bat` |
| 문서 | [CHANGELOG.md](./CHANGELOG.md) · [SECURITY-hwpx-reapply-1cell-20260914.md](./SECURITY-hwpx-reapply-1cell-20260914.md) |

### 2026-09-14

| 항목 | 내용 |
|------|------|
| 분류 | HWPX **한 칸** 사진·캡션 덩어리(앱 칸 이름·값) |
| APK | `releases/VoiceStamp_20260914_142225.apk` |
| 롤백 | `restore-hwpx-caption-blob.bat` |
| 문서 | [CHANGELOG.md](./CHANGELOG.md) · [SECURITY-hwpx-caption-blob-20260914.md](./SECURITY-hwpx-caption-blob-20260914.md) |
...
### 2026-08-23 (저장 목록 엑셀 사진 가로)

| 항목 | 내용 |
|------|------|
| 분류 | 저장 목록 엑셀 **사진 가로**(수신과 동일 기억값) |
| APK | `releases/VoiceStamp_20260823_173038.apk` — [CHANGELOG.md](./CHANGELOG.md) |
