...
문서 작성일: **2026-07-31**
최신 기능 커밋 기준: `9d8ccfa` — **성능 번들 B** · APK `VoiceStamp_20260801_191117` · 이전 `e45026b`
...
| 파일 | 커밋 | 비고 |
|------|------|------|
| **`releases/VoiceStamp_20260801_191117.apk`** | `9d8ccfa` | **설치·GitHub 권장** — **성능 번들 B** + A 누적 |
...
| APK 파일 | 커밋 | 주요 변경 | 배포 |
|----------|------|-----------|------|
| `releases/VoiceStamp_20260801_191117.apk` | `9d8ccfa` | **권장** — **성능 번들 B** · `restore-perf-bundle-b.bat` | **GitHub `releases/`** |
...
> **권장 APK:** `releases/VoiceStamp_20260801_191117.apk` `9d8ccfa`.
