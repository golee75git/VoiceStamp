...
문서 작성일: **2026-07-31**
최신 기능 커밋 기준: (본 커밋) — QR URL **연결확인** · APK `VoiceStamp_20260801_172149` · 이전 `a9509b9`/`626c1a4`
...
| 343 | **QR URL 연결확인** (사설망 차단·타임아웃 GET) | (본 커밋) | `restore-qr-url-check.bat` §203 |
| 344 | GitHub APK `releases/20260801_172149` · 랜딩·`/info` | (본 커밋) | `restore-apk-download-20260801_172149.bat` |

> **권장 APK:** `releases/VoiceStamp_20260801_172149.apk`
...
| 파일 | 커밋 | 비고 |
|------|------|------|
| **`releases/VoiceStamp_20260801_172149.apk`** | (본 커밋) | **설치·GitHub 권장** — QR URL **연결확인** + 07-31 누적 |
...
| APK 파일 | 커밋 | 주요 변경 | 배포 |
|----------|------|-----------|------|
| `releases/VoiceStamp_20260801_172149.apk` | (본 커밋) | **권장** — QR URL **연결확인** · `restore-qr-url-check.bat` | **GitHub `releases/`** |
...
> **권장 APK:** `releases/VoiceStamp_20260801_172149.apk` (본 커밋).
