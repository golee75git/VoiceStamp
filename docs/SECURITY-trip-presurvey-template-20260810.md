# SECURITY — 체험여행 사전답사기록 기본 템플릿 (2026-08-10)

## 변경 요약
- 기본 저장 템플릿에 「체험여행 사전답사기록」추가
- 표시명: 여행명·답사장소·답사내용·체험활동·확인사항·답사단계
- 신규 네트워크·권한·패키지 없음. 정적 상수만 추가.

## 파일 구분
| 구분 | 경로 |
|------|------|
| **신규** | `restore-trip-presurvey-template.bat`, 본 문서 |
| **재사용·수정** | `src/services/stampFieldTemplates.ts`, `public/help.html`, `RESTORE.md` |
| **스냅샷** | `src.pre-trip-presurvey-template/`, `public.pre-trip-presurvey-template/` |
