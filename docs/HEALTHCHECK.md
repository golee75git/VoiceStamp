...
| 문서 버전 | 1.0 |
| 고정일 | 2026-08-01 |
| 기준 APK | `VoiceStamp_20260801_193317.apk` (`073c8bf`) |
...
| `VoiceStamp_20260801_193317.apk` | `073c8bf` | **권장** 번들 C (+B/A) |

상세 날짜·APK 이력: [PRD.md](./PRD.md) §12–13 · [PLAN.md](./PLAN.md) §10–11 · [PROJECT.md](./PROJECT.md) §4·§7.4·§12
