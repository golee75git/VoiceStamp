...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260711_074726.apk` (`40805e9`) — **층 school_only** 비학교 lastFloor/저장 가드 + 07-10 전부
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260711_074726.apk
- **이전 권장 APK:** `releases/VoiceStamp_20260710_233524.apk` (`a0d05b9`, 손잡이·촬영음·배율)
...
| 07-11 | **층 school_only** 비학교 lastFloor/저장 가드 · APK `074726` |

### APK별 (권장·주요)

| APK | 커밋 | 한 줄 |
|-----|------|--------|
| `releases/VoiceStamp_20260711_074726.apk` | `40805e9` | **설치·GitHub 권장** — **층 school_only** 비학교 lastFloor/저장 가드 |
