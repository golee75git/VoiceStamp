...
| [../RESTORE.md](../RESTORE.md) | 기능별 되돌리기 (§1~159) |
...
- **문서 갱신일:** 2026-07-22 — **앱 내 카메라 크롭「적용」수정**(getSize 레이스·뷰포트 수식) · APK `000609`
- **최신 기능 커밋:** (본 배포 커밋) — 앱 내 고해상도 사진 확대 적용 수정
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260722_000609.apk` — **앱 내·시스템 카메라 크롭 적용** + 07-20 PDF 현장 폴더
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260722_000609.apk
- **이전 권장 APK:** `releases/VoiceStamp_20260721_235129.apk` (`225635` 크롭 계열 복구본)
...
| 07-22 | **앱 내 카메라 크롭「적용」수정**(getSize/onLayout 레이스·뷰포트 수식·UI flush) · APK `000609` · Vercel |
...
| `releases/VoiceStamp_20260720_225635.apk` | `6060a48` | **이전** — PDF → 현장 폴더 archive |
