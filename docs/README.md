...
- **문서 갱신일:** 2026-08-17 — 종료 안내 사업명
- **최신 기능 커밋:** `1730c0f` / APK `101059` — 종료 안내에 사업 이름
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260817_101059.apk` — 종료 안내에 사업 이름
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260817_101059.apk
...
> **2026-08-17:** 권장 파일은 **`VoiceStamp_20260817_101059.apk`**. 요약: [CHANGELOG.md](./CHANGELOG.md).
