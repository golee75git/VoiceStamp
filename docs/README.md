...
- **문서 갱신일:** 2026-08-18 — 참여 목록 종료됨 표시
- **최신 기능 커밋:** APK `091805` — 참여 목록 종료됨 표시
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260818_091805.apk` — 참여 목록 종료됨 표시
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260818_091805.apk
...
| 08-18 | 참여 목록 **종료됨** 표시·올리기 단추 숨김 · APK `091805` |
...
> **2026-08-18:** 권장 파일은 **`VoiceStamp_20260818_091805.apk`**. 요약: [CHANGELOG.md](./CHANGELOG.md).
