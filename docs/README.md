...
- **권장 APK (로컬):** `VoiceStamp_20260617_131932.apk` — 오버레이 한 바·**파스텔 10색** 워터마크·/report JPEG·갤러리·촬영 캡슐
...
| 06-17 | **워터마크** 검은/흰 → `/report` JPEG·보라 아이콘·**10색 파스텔**·**기관명/하단 문구**·워터마크 **한 바** |

### APK별 (권장·주요)

| APK | 커밋 | 한 줄 |
|-----|------|--------|
| `VoiceStamp_20260617_131932.apk` | `3e6a90d` | **설치 권장** — 오버레이 한 바·파스텔 10색 |
