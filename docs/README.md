...
| [SECURITY-field-ink-20260917.md](./SECURITY-field-ink-20260917.md) | 보안·UX | 저장·수정 칸 본문 글자색 고정 |
| [SECURITY-note-pad-tune-20260916.md](./SECURITY-note-pad-tune-20260916.md) | 보안·UX | 글 넣기·크기·투명도 막대·저장 위치 맞춤 |
...
| [../RESTORE.md](../RESTORE.md) | 기능별 되돌리기 (§1~213) |
...
- **문서 갱신일:** 2026-09-17 — **저장 칸 본문 글자색** · APK `094104`
- **최신 기능 커밋:** (본 배포) · APK `094104` — 저장·수정 칸 본문 글자색 고정
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260917_094104.apk` — 저장·수정 칸 본문 글자색 고정
- **APK raw URL (GitHub):** https://raw.githubusercontent.com/golee75git/VoiceStamp/main/releases/VoiceStamp_20260917_094104.apk
- **이전 권장 APK:** `releases/VoiceStamp_20260916_104154.apk` — 글 넣기·크기·투명도 막대·저장 위치 맞춤
...
- **이전 권장 APK:** `releases/VoiceStamp_20260914_183910.apk` — 저장 화면 칸 이름 탭이 메모로 내려가지 않음
...
- **이전 권장 APK:** `releases/VoiceStamp_20260914_131007.apk` — HWPX 첫 사진 누락·표 넘침 보정
- **이전 권장 APK:** `releases/VoiceStamp_20260914_112329.apk` — 한글 저장 사진 표 서식 적용
- **이전 권장 APK:** `releases/VoiceStamp_20260911_175943.apk` — HWPX 110523 문단 방식(실기기 검증)
- **이전 권장 APK:** `releases/VoiceStamp_20260911_170631.apk` — HWPX 실제 서식 재사용 표(실기기 열었으나 사진·캡션 빈 페이지)
...
- **이전 권장 APK:** `releases/VoiceStamp_20260911_131258.apk` — HWPX 사진 위 표
- **이전 권장 APK:** `releases/VoiceStamp_20260910_184615.apk` — HWPX 캡션 한 줄(·) 표시
- **이전 권장 APK:** `releases/VoiceStamp_20260910_163646.apk` — HWPX 별도 영역형 캡션
...
- **이전 권장 APK:** `releases/VoiceStamp_20260817_074537.apk` — 설정 표시 그림을 캡션·워터마크 JPEG에 합성
- **이전 권장 APK:** `releases/VoiceStamp_20260816_202344.apk` — 미리보기 QR 열기 중에도 셔터 촬영
- **이전 권장 APK:** `releases/VoiceStamp_20260816_190729.apk` — 앱 내 미리보기 QR 열기
- **이전 권장 APK:** `releases/VoiceStamp_20260816_181459.apk` — 기본 템플릿 홍보기록
- **이전 권장 APK:** `releases/VoiceStamp_20260816_171905.apk` — 보낸 사진 갤러리·촬영 표시
- **이전 권장 APK:** `releases/VoiceStamp_20260816_164812.apk` — 참여 사업 갤러리·목록 보내기
...
| 08-23 | 날짜별·APK별 문서 정리 (소스 없음) · 권장 `181951` (`4f27cd0`) |
| 08-23 | 연결 비교 엑셀 **사진 가로** · APK `181951` (`bba7014`) |
