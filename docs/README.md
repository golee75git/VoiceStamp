...
- **문서 갱신일:** 2026-08-18 — 셔터 시 미리보기 유지
- **최신 기능 커밋:** APK `112120` — 셔터 시 미리보기 유지·3:4 위쪽 고정
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260818_112120.apk` — 셔터 시 미리보기 유지
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260818_112120.apk
- **이전 권장 APK:** `releases/VoiceStamp_20260818_105424.apk` — 앱 내 미리보기 검정 화면 수정
