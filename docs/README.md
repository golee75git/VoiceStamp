...
| [../RESTORE.md](../RESTORE.md) | 기능별 되돌리기 (§1~156) |
...
- **문서 갱신일:** 2026-07-21 — **확대「적용」=라이브 줌 shared value** · APK `232039`
- **최신 기능 커밋:** (본 배포 커밋) — 크롭 적용 시 화면 줌을 직접 읽어 저장
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260721_232039.apk` — **적용=라이브 크롭** + 뷰포트 수식 + 07-20 PDF 현장 폴더 등
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260721_232039.apk
- **이전 권장 APK:** `releases/VoiceStamp_20260721_215051.apk` (크롭 뷰포트 수식)
...
| 07-21 | **확대 크롭「적용」=화면 가시 영역** · **적용=라이브 줌** · 도움말 · APK `215051`→`232039` · Vercel |

### APK별 (권장·주요)

> **2026-07-21:** 권장 파일은 **`VoiceStamp_20260721_232039.apk`**.

| APK | 커밋 | 한 줄 |
|-----|------|--------|
| `releases/VoiceStamp_20260721_232039.apk` | (본 배포) | **설치·GitHub 권장** — **적용=라이브 크롭** + 뷰포트 수식 + 07-20 전부 |
