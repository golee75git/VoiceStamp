...
- **문서 갱신일:** 2026-08-16 — 보낸 사진 갤러리·촬영 표시
- **최신 기능 커밋:** `cd575ce` / APK `171905` — 보낸 사진 갤러리·촬영 표시
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260816_171905.apk` — 보낸 사진 갤러리·촬영 표시
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260816_171905.apk
...
| 08-16 | 엑셀 **5장 이상 가로 막대** · APK `141835` · 막대 **즉시 표시**·만든 사업 엑셀 제거 · APK `150607` · **저장 후 공유** · APK `154152` · **갤러리·목록 보내기** · APK `164812` · **보낸 사진 갤러리·촬영** · APK `171905` |

### APK별 (권장·주요)

> **2026-08-16:** 권장 파일은 **`VoiceStamp_20260816_171905.apk`** (`cd575ce`). 요약: [CHANGELOG.md](./CHANGELOG.md).
