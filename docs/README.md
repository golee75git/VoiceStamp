...
- **문서 갱신일:** 2026-08-17 — 설정 표시 그림 JPEG 합성
- **최신 기능 커밋:** `2dadfea` / APK `074537` — 설정 표시 그림을 캡션·워터마크 JPEG에 합성
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260817_074537.apk` — 설정 표시 그림을 캡션·워터마크 JPEG에 합성
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260817_074537.apk
...
| 08-17 | 설정 **표시 그림** JPEG 합성 · APK `074537` |
...
> **2026-08-17:** 권장 파일은 **`VoiceStamp_20260817_074537.apk`**. 요약: [CHANGELOG.md](./CHANGELOG.md).
