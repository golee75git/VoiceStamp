...
- **문서 갱신일:** 2026-09-14 — **수신함 이 폰 사진 표시** · APK `230623`
- **최신 기능 커밋:** (본 배포) · APK `230623` — 수신함에서 이 폰 원본 썸네일
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260914_230623.apk` — 수신함 이 폰 사진 표시
- **APK raw URL (GitHub):** https://raw.githubusercontent.com/golee75git/VoiceStamp/main/releases/VoiceStamp_20260914_230623.apk
