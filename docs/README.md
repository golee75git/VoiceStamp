...
- **문서 갱신일:** 2026-09-16 — **글 넣기·막대 조절** · APK `104154`
- **최신 기능 커밋:** (본 배포) · APK `104154` — 글 넣기·크기·투명도 막대·저장 위치 맞춤
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260916_104154.apk` — 글 넣기·크기·투명도 막대·저장 위치 맞춤
- **APK raw URL (GitHub):** https://raw.githubusercontent.com/golee75git/VoiceStamp/main/releases/VoiceStamp_20260916_104154.apk
- **이전 권장 APK:** `releases/VoiceStamp_20260916_002642.apk` — Android PDF·HWPX 저장 시 사진 위 글 칸
