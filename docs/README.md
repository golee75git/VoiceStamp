...
- **문서 갱신일:** 2026-08-18 — 앱 내 미리보기 검정 화면 수정
- **최신 기능 커밋:** APK `105424` — 앱 내 미리보기 검정 화면 수정
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260818_105424.apk` — 앱 내 미리보기 검정 화면 수정
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260818_105424.apk
- **이전 권장 APK:** `releases/VoiceStamp_20260818_103007.apk` — 앱 내 미리보기 3:4 비율 맞춤
...
| 08-18 | 앱 내 미리보기 **검정 화면 수정** · APK `105424` · **3:4 비율 맞춤** · APK `103007` · 참여 목록 **종료됨** 표시 · APK `091805` · 보낸 사진 하단 바 여백 · APK `094501` |
...
> **2026-08-18:** 권장 파일은 **`VoiceStamp_20260818_105424.apk`**. 요약: [CHANGELOG.md](./CHANGELOG.md).
