...
- **문서 갱신일:** 2026-09-14 — **HWPX 첫 사진** 누락·표 넘침 보정 · APK `131007`
- **최신 기능 커밋:** (본 배포) · APK `131007` — HWPX 첫 사진 BinData/hpf·표 안 맞춤·제목 다음 쪽
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260914_131007.apk` — HWPX 첫 사진 누락·표 넘침 보정
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260914_131007.apk
