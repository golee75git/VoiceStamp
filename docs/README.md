...
- **문서 갱신일:** 2026-08-16 — 기본 템플릿 홍보기록
- **최신 기능 커밋:** `3f157ef` / APK `181459` — 기본 템플릿 홍보기록
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260816_181459.apk` — 기본 템플릿 홍보기록
- **APK raw URL (GitHub):** https://github.com/golee75git/VoiceStamp/raw/main/releases/VoiceStamp_20260816_181459.apk
...
| 08-16 | 엑셀 **5장 이상 가로 막대** · APK `141835` · 막대 **즉시 표시**·만든 사업 엑셀 제거 · APK `150607` · **저장 후 공유** · APK `154152` · **갤러리·목록 보내기** · APK `164812` · **보낸 사진 갤러리·촬영** · APK `171905` · **홍보기록** · APK `181459` |

### APK별 (권장·주요)

> **2026-08-16:** 권장 파일은 **`VoiceStamp_20260816_181459.apk`** (`3f157ef`). 요약: [CHANGELOG.md](./CHANGELOG.md).
