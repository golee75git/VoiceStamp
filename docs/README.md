...
- **문서 갱신일:** 2026-09-14 — **HWPX 한글 1칸 서식 재적용** · APK `144257`
- **최신 기능 커밋:** (본 배포) · APK `144257` — 한글 1칸 `report.hwpx` 재적용, 랜딩 APK 직접 다운로드
...
- **권장 APK (설치·GitHub):** `releases/VoiceStamp_20260914_144257.apk` — HWPX 한글 1칸 서식 재적용
- **APK raw URL (GitHub):** https://raw.githubusercontent.com/golee75git/VoiceStamp/main/releases/VoiceStamp_20260914_144257.apk
