...
| 문서 작성일 | 2026-07-31 |
| 문서 동기화 | 2026-08-23 — 날짜별·APK별 정리 · 권장 `181951` (`bba7014`) |
...
| F-EXP-03 | 선택 스탬프 → **HWPX** (한글 저장 서식 `report.hwpx` 위칸 사진·아래칸 캡션; 사진은 칸 높이 맞춤; 첫 사진은 제목 다음 쪽; **바이너리 저장**) | ✅ |
...
| **2026-09-14** | **HWPX 사진·캡션 표** 칸 적용·사진 크게 · 도움말 · APK `134700` · `restore-hwpx-pic-caption.bat` | (본 커밋) |
