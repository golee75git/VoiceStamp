...
| **2026-09-17** | 저장·수정 **칸 본문 글자색**을 흰 바탕에 어둡게 고정 · 도움말 · APK `094104` · `restore-field-ink.bat` | (본 커밋) |
...
> **2026-09-17:** 권장 파일은 **`VoiceStamp_20260917_094104.apk`**. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md).
