...
| 문서 작성일 | 2026-07-31 |
| 문서 동기화 | 2026-09-15 — 저장·수정 입력칸 키보드 가림 · 권장 `075220` |
| 최신 반영 커밋 | (본 배포) 저장·수정 입력칸이 키보드에 가리지 않음 |
...
| **2026-09-15** | 저장·수정 입력칸이 **키보드에 가리지 않게** · 도움말 · APK `075220` · `restore-save-kb-clear.bat` | (본 커밋) |
...
> **2026-09-15:** 권장 파일은 **`VoiceStamp_20260915_075220.apk`**. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md).
