...
| **2026-09-14** | 저장 목록 **사업으로 보내기** 고르기·연결 확인 · 도움말 · APK `223408` · `restore-join-list-send-check.bat` | (본 커밋) |
...
> **2026-09-14:** 권장 파일은 **`VoiceStamp_20260914_223408.apk`**. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md).
