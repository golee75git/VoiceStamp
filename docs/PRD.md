...
| **2026-09-14** | **HWPX 표·사진 조금 작게**(한 쪽) · 도움말 · APK `151454` · `restore-hwpx-table-slack.bat` | (본 커밋) |
...
> **2026-09-14:** 권장 파일은 **`VoiceStamp_20260914_151454.apk`**. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md).
