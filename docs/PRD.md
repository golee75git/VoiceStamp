...
| **2026-08-18** | 앱 내 미리보기 **3:4 비율 맞춤**(자르기 없음) · 도움말 · APK `103007` · `restore-inapp-preview-fit.bat` | (푸시 후) |
...
> **2026-08-18:** 권장 파일은 **`VoiceStamp_20260818_103007.apk`**. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md).
