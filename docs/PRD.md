...
| 문서 작성일 | 2026-07-31 |
| 문서 동기화 | 2026-09-14 — HWPX 표·사진 조금 작게 · 권장 `151454` |
| 최신 반영 커밋 | (본 배포) HWPX 표·사진 조금 작게 |
...
| **2026-09-14** | 수신함 **이 폰** 사진 표시 · 도움말 · APK `230623` · `restore-inbox-on-device.bat` | (본 커밋) |
...
> **2026-09-14:** 권장 파일은 **`VoiceStamp_20260914_230623.apk`**. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md).
