...
| **2026-09-17** | 사진 위 글 **저장 위치를 글자 상단에 맞춤** · 도움말 · APK `102508` · `restore-note-pad-rise.bat` | (본 커밋) |
...
> **2026-09-17:** 권장 파일은 **`VoiceStamp_20260917_102508.apk`**. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md).
