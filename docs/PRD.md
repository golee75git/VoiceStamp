...
| F-EXP-03 | 선택 스탬프 → **HWPX** (한글 저장 서식 `report.hwpx`의 사진 표+자리 표시; 첫 사진은 제목 다음 쪽; **바이너리 저장**) | ✅ |
...
| **2026-09-14** | **HWPX 첫 사진** 누락·표 넘침 보정 · 도움말 · APK `131007` · `restore-hwpx-first-pic.bat` | (본 커밋) |
