...
| 문서 작성일 | 2026-07-31 |
| 문서 동기화 | 2026-09-15 — 사진 위 글 칸 · 권장 `095143` |
| 최신 반영 커밋 | (본 배포) 저장·수정 큰 미리보기 사진 위 글 칸 |
...
| **2026-09-15** | 저장·수정 큰 미리보기 **사진 위 글 칸**(최대 8) · 이미지 저장 JPEG · 도움말 · APK `095143` · `restore-photo-note-pad.bat` | (본 커밋) |
...
> **2026-09-15:** 권장 파일은 **`VoiceStamp_20260915_095143.apk`**. 채널: [RELEASE-CHANNELS.md](./RELEASE-CHANNELS.md). 성능: [HEALTHCHECK.md](./HEALTHCHECK.md).
