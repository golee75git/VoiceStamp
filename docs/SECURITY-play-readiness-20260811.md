...
| HWPX 리포트 템플릿 | ~~`public/templates/report.hwpx` 출처 미확인~~ → 한글 저장 `report.hwpx` + 자리 표시 (2026-08-18) | 운영자가 한글에서 저장한 문서. 외부 예제 미사용 |
...
- [x] C3 HWPX 서식 — 2026-08-18 한글 저장 문서+자리 표시로 정리 (`report.hwpx`)
